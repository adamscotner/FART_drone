...
public:
	...
	void setDutyTimeTest(unsigned int duty_us); 											//sets active duty time
	...
	void setSigScaleTest(float relSignal);										//set the 0..1 value of duty time
